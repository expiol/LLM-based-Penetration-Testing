    ...
    if ToolCapability.SCRIPT_EXEC in allowed:
        rules.extend(
            [
                ...
                "script.exec starts in a disposable copy of files_root; use relative paths or CTF_FILES_ROOT for challenge files and generated artifacts. Use CTF_TEMP_DIR or tempfile for scratch files. Do not write to /tmp, /home outside CTF_FILES_ROOT, or CTF_ORIGINAL_FILES_ROOT.",
