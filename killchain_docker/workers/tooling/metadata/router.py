...
from killchain_docker.workers.tooling.metadata.artifact import (
...
from killchain_docker.workers.tooling.metadata.http import normalize_curl_metadata
from killchain_docker.workers.tooling.metadata.common import (
    merge_tool_metadata,
    populated_contract_fields,
)
from killchain_docker.workers.tooling.metadata.script import normalize_script_metadata
from killchain_docker.workers.tooling.metadata.shell import normalize_shell_metadata
