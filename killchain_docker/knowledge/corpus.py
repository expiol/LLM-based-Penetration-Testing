...
"matter".  The vector RAG provider then uses dense cosine similarity
(no BM25) for ranking — see :mod:`killchain_docker.knowledge.embedder` and
:mod:`killchain_docker.rag.vector`.
"""
