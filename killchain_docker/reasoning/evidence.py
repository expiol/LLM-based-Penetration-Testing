...
sqlite, pcap, repo) all follow the same pattern:
  ...
  1. Run a capability to produce a structured evidence bundle.
...
from killchain_docker.reasoning.schemas import EvidenceReviewGuidance
...
def review_evidence_with_llm(
    ...
    *,
    ...
    """Ask the LLM to enrich evidence-heavy capability output.
